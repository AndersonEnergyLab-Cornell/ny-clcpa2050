...
#2036-2085
	...
	for year in range(1998,2020):
		...
		# print(formatted)
		ct_array = ct_array
		directory = 'Load/ResLoad/Scenario'+str(scenario)

		if not os.path.exists(directory):
			os.makedirs(directory)
			
		# ct_array = ct_array.reshape((46,8761))
		np.savetxt('Load/ResLoad/Scenario'+str(scenario)+'/ResLoad_Bus_'+str(year)+'.csv',ct_array,delimiter=',')
